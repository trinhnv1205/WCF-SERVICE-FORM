...
namespace SVService.App_Data
{
    public class DbAccess : IDisposable
    {
        ...
        {
            //var connectionString = ConfigurationManager.ConnectionStrings["sieuthi"].ConnectionString;
            return "Data Source=DESKTOP-S4UQLVE;Initial Catalog=sieuthi;Integrated Security=True;";
